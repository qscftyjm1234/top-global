 ...
 * @LastEditTime: 2024-07-15 17:41:38
 * @FilePath: \top-glob\nuxt.config.ts
...
export default defineNuxtConfig({
  ...
  router: {
    ...
    rewritePaths: {
      '/api/v1/user/member/waybill/searchDetailV2': {
        target: 'http://jingya.api.8bami.com/v1/user/member/waybill/searchDetailV2',
        changeOrigin: true,
        secure: false
      }
    }
