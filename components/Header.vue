 ...
 * @LastEditTime: 2024-04-16 16:02:01
        ...
        <el-affix :offset="0">
            ...
            >
                    <div style="display: flex; align-items: center;">
                        <NuxtLink to="/" style="display: flex; align-items: center; margin-right: 8px; padding: 12px">
                            <el-avatar :size="48">
                                <img
                        ...
                        <div style="display: flex; align-items: center; font-weight: bold">TGE 邏捷運通有限公司</div>
